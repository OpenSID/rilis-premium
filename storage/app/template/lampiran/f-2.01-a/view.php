...
<page orientation="portrait" format="210x330" style="font-size: 7pt">
    ...
    <!-- Header Dispenduk Capil (jika ada) -->
    <?php if (!empty($config['header_surat_dispenduk']) ?? ''): ?>
        <?= $config['header_surat_dispenduk'] ?>
    <?php endif; ?>

    <!-- Awal Halaman 1 -->
    <table id="kode" align="right">
        <tr><td><strong>F-2.01 A</strong></td></tr>
    </table>
    <table class="disdukcapil" style="border: 0px;">
        <col span="48" style="width: 2.0833%;">
        <tr><td colspan="48">&nbsp;</td></tr>
        <tr>
            <td colspan="10">Provinsi</td>
            <td>: </td>
            <td colspan="37" style="text-transform: uppercase;"><?= $config['nama_propinsi']; ?></td>
        </tr>
        <tr>
            <td colspan="10">Kabupaten</td>
            <td>: </td>
            <td colspan="37" style="text-transform: uppercase;"><?= $config['nama_kabupaten']; ?></td>
        </tr>
        <tr>
            <td colspan="10">Kecamatan</td>
            <td>: </td>
            <td colspan="37" style="text-transform: uppercase;"><?= $config['nama_kecamatan']; ?></td>
        </tr>
        <tr>
            <td colspan="10">Desa/Kelurahan</td>
            <td>: </td>
            <td colspan="37" style="text-transform: uppercase;"><?= $config['nama_desa']; ?></td>
        </tr>
        <tr>
    ...
    <table class="disdukcapil" style="margin-top: 5px;">
        ...
        <tr>
            <td colspan="13">Nomor Dokumen Perjalanan RI*</td>
            <td class="kanan">:</td>
    ...
    <table class="disdukcapil" style="margin-top: 5px;">
        <col span="48" style="width: 2.0833%;">
        <tr>
            <td colspan="48"><strong>DATA SUBJEK AKTA</strong></td>
        </tr>
        <tr>
            <td colspan="13">Nama</td>
            <td class="kanan">:</td>
    ...
    <table class="disdukcapil" style="margin-top: 5px;">
        <col span="48" style="width: 2.0833%;">
        <tr>
            <td colspan="48"><strong>KELAHIRAN</strong></td>
        </tr>
        <tr>
            <td>1.</td>
            <td colspan="12">Nama</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? $individu['nama'] : '', 34); ?>
        </tr>
        <tr>
            <td>2.</td>
            <td colspan="12">Jenis kelamin</td>
            <td class="kanan">:</td>
            <?= checklist($isi_data_anak ? $individu['sex'] : '', 'Laki-laki'); ?>
            <td colspan="6">1. Laki-laki </td>
            <?= checklist($isi_data_anak ? $individu['sex'] : '', 'Perempuan'); ?>
        ...
        <tr>
            ...
            <td class="kanan">:</td>
            <?= checklist($isi_data_anak ? $individu['tempat_dilahirkan'] : '', 1); ?>
            <td colspan="4">1. RS/SB</td>
            <?= checklist($isi_data_anak ? $individu['tempat_dilahirkan'] : '', 2); ?>
            <td colspan="5">2. Puskesmas </td>
            <?= checklist($isi_data_anak ? $individu['tempat_dilahirkan'] : '', 3); ?>
            <td colspan="4">3. Polindes</td>
            <?= checklist($isi_data_anak ? $individu['tempat_dilahirkan'] : '', 4); ?>
            <td colspan="4">4. Rumah </td>
            <?= checklist($isi_data_anak ? $individu['tempat_dilahirkan'] : '', 5); ?>
        ...
        <tr>
            ...
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? $individu['tempatlahir'] : '', 34); ?>
        </tr>
        <tr>
            <td>5.</td>
            ...
            <td>Hari</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? hari($individu['tanggallahir']) : '', 6); ?>
            <td colspan="4">&nbsp;</td>
            <td>Tgl</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? date('dd', strtotime($individu['tanggallahir'])) : '', 2); ?>
            <td>Bln</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? date('mm', strtotime($individu['tanggallahir'])) : '', 2); ?>
            <td>Thn</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? date('Y', strtotime($individu['tanggallahir'])) : '', 4); ?>
        </tr>
        <tr>
            <td>6.</td>
            <td colspan="12">Pukul </td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_anak ? $individu['waktu_lahir'] : '', 5); ?>
        </tr>
        <tr>
            <td>7.</td>
            <td colspan="12">Jenis kelahiran </td>
            <td class="kanan">:</td>
            <?= checklist($isi_data_anak ? $individu['jenis_kelahiran'] : '', 1); ?>
            <td colspan="4">1. Tunggal</td>
            <?= checklist($isi_data_anak ? $individu['jenis_kelahiran'] : '', 2); ?>
            <td colspan="4">2. Kembar 2 </td>
            <?= checklist($isi_data_anak ? $individu['jenis_kelahiran'] : '', 3); ?>
            <td colspan="5">3. Kembar 3</td>
            <?= checklist($isi_data_anak ? $individu['jenis_kelahiran'] : '', 4); ?>
            <td colspan="4">4. Kembar 4 </td>
            <?= checklist($isi_data_anak ? $individu['jenis_kelahiran'] : '', 5); ?>
            <td colspan="4">5. Lainnya &nbsp; </td>
        </tr>
        <tr>
            <td>8.</td>
        ...
        <tr>
            ...
            <td class="kanan">:</td>
            <?= checklist($isi_data_anak ? $individu['penolong_kelahiran'] : '', 1); ?>
            <td colspan="4">1. Dokter</td>
            <?= checklist($isi_data_anak ? $individu['penolong_kelahiran'] : '', 2); ?>
            <td colspan="6">2. Bidan/Perawat</td>
            <?= checklist($isi_data_anak ? $individu['penolong_kelahiran'] : '', 3); ?>
            <td colspan="4">3. Dukun</td>
            <?= checklist($isi_data_anak ? $individu['penolong_kelahiran'] : '', 4); ?>
        ...
        <tr>
            ...
            <td colspan="2" class="kotak padat tengah">
                <?= $isi_data_anak ? $individu['berat_lahir_kg'] : '' ?>
            </td>
            <td> kg</td>
        </tr>
        <tr>
            ...
            <td class="kanan">:</td>
            <td colspan="2" class="kotak padat tengah">
                <?= $isi_data_anak ? $individu['panjang_lahir'] : '' ?>
            </td>
            <td> cm</td>
        </tr>
    </table>
...
<page orientation="portrait" format="210x330" style="font-size: 7pt">
    ...
    <table class="disdukcapil" style="margin-top: 5px;">
        ...
        <tr>
            ...
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian ? $input['nik_kematian'] : '', 16); ?>
        </tr>
        <tr>
            <td>2.</td>
            <td colspan="12">Nama Lengkap</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian ? $input['nama_kematian'] : '', 34); ?>
        </tr>
        <tr>
            <td>3.</td>
            ...
            <td>Tgl</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian && ! empty($input['tanggal_kematian']) ? date('dd', strtotime($input['tanggal_kematian'])) : '', 2); ?>
            <td>Bln</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian && ! empty($input['tanggal_kematian']) ? date('mm', strtotime($input['tanggal_kematian'])) : '', 2); ?>
            <td>Thn</td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian && ! empty($input['tanggal_kematian']) ? date('Y', strtotime($input['tanggal_kematian'])) : '', 4); ?>
        </tr>
        <tr>
            <td>4.</td>
            <td colspan="12">Pukul </td>
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian ? $input['jam_kematian'] : '', 5); ?>
        </tr>
        <tr>
            <td>5.</td>
            <td colspan="12">Sebab kematian</td>
            <td class="kanan">:</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 1); ?>
            <td colspan="7">1. Sakit biasa / tua</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 2); ?>
            <td colspan="7">2. Wabah Penyakit</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 3); ?>
            <td colspan="7">3. Kecelakaan</td>
        </tr>
        <tr>
            <td colspan="14">&nbsp;</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 4); ?>
            <td colspan="7">4. Kriminalitas</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 5); ?>
            <td colspan="7">5. Bunuh Diri</td>
            <?= checklist($isi_data_kematian ? $input['sebab_kematian'] : '', 6); ?>
        ...
        <tr>
            ...
            <td class="kanan">:</td>
            <?= kotak($isi_data_kematian ? $input['tempat_kematian'] : '', 34); ?>
        </tr>
        <tr>
            <td>7.</td>
            <td colspan="12">Yang menerangkan</td>
            <td class="kanan">:</td>
            <?= checklist($isi_data_kematian ? $input['penolong_kematian'] : '', 1); ?>
            <td colspan="4">1. Dokter</td>
            <?= checklist($isi_data_kematian ? $input['penolong_kematian'] : '', 2); ?>
            <td colspan="8">2. Tenaga Kesehatan</td>
            <?= checklist($isi_data_kematian ? $input['penolong_kematian'] : '', 3); ?>
            <td colspan="5">3. Kepolisian</td>
            <?= checklist($isi_data_kematian ? $input['penolong_kematian'] : '', 4); ?>
