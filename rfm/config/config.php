...
if (isset($GLOBALS['RFM_AUTH']['fm_key']) && ! empty($GLOBALS['RFM_AUTH']['fm_key'])) {
    $_SESSION['fm_key']                  = $GLOBALS['RFM_AUTH']['fm_key'];
    $_SESSION['hapus_gambar_rfm']        = $GLOBALS['RFM_AUTH']['hapus_gambar_rfm'] ?? false;
    $_SESSION['ubah_tambah_gambar_rfm']  = $GLOBALS['RFM_AUTH']['ubah_tambah_gambar_rfm'] ?? false;
    ...
    */
    ...
    $request_uri = str_replace('/rfm/dialog.php', '', $_SERVER['REQUEST_URI']);
    if (strpos($request_uri, '?') !== false) {
        $request_uri = substr($request_uri, 0, strpos($request_uri, '?'));
    }

    $base_path = rtrim($request_uri, '/');
    ...
    $config = [
        ...
        */
        ...
        'ftp_temp_folder'  => "../temp/", // Directory where place files before to send to FTP with final /
        ...
        */
        ...
        'image_resizing_override' => false,  // If set to TRUE then you can specify bigger images than $image_max_width & height otherwise if image_resizing is bigger than $image_max_width or height then it will be converted to those values
        ...
        */
        ...
        /*
        | padding: If using a pre-determined position you can adjust the padding from the edges by passing an amount
        ...
        */
        ...
        'ext_file'  => ['doc', 'docx','pdf','xls', 'xlsx'], // Files
    ...
    return array_merge(
        ...
        [
            ...
            'tui_defaults_config' => [
                ...
                // 'submenu.activeLabel.fontWeight' => $config['submenu.activeLabel.fontWeight'],
