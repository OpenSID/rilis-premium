...
<div class="tab-pane" id="footer">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea name="{{ setting('tte') == '1' ? 'footer_surat_tte' : 'footer_surat' }}" class="form-control input-sm editor required" data-filemanager='<?= json_encode(['external_filemanager_path' => filemanager_base_url(), 'filemanager_title' => 'File Manager']) ?>' data-salintemplate="header-footer"
