...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('surat_mohon') }}">Dokumen Persyaratan Surat</a></li>
...
@section('content')
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            @include('admin.layouts.components.tombol_kembali', ['url' => url('surat_mohon'), 'label' => 'Dokumen Persyaratan Surat'])
        </div>
        <div class="box-body">
            <form action="{{ $form_action }}" method="POST" class="form-horizontal" id="validasi">
                <div class="box-body">
