            ...
            <div class="box-body">
                ...
                <div class="checkbox">
                    <label>
                        ...
                        Saya telah membuka
                        <a href="{{ route('database.bersih_folder') }}" target="_blank"><i class="fa fa-external-link"></i> Bersih Folder Desa</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body-acak">
                ...
                <ul>
                    <li>Database asli <strong>sudah dibackup</strong> menggunakan fitur Backup di tab sebelah.</li>
