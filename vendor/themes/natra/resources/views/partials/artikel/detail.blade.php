...
<div class="single_page_area" id="{{ 'artikel-' . $single_artikel['judul'] }}">
	...
	<div class="single_category wow fadeInDown">
		<h2> <span class="bold_line"><span></span></span> <span class="solid_line"></span> <span
				class="title_text">Artikel</span> </h2>
	</div>
	<div id="printableArea">
		...
		<div class="single_page_content" style="margin-bottom:10px;">
			...
			@endif
			<div class="sampul">
				@if ($single_artikel['gambar'] != '' and is_file(LOKASI_FOTO_ARTIKEL . "sedang_" .
				$single_artikel['gambar']))
				<a data-fancybox="gallery" href="{{ AmbilFotoArtikel($single_artikel['gambar'], 'sedang') }}">
					<img width="270px" style="float:left; margin:0 8px 4px 0;" class="img-fluid img-thumbnail"
			...
			<div class="sampul">
				<a data-fancybox="gallery" href="{{ AmbilFotoArtikel($single_artikel['gambar1'], 'sedang') }}">
					<img width="270px" style="float:left; margin:0 8px 4px 0;" class="img-fluid img-thumbnail"
						src="{{ AmbilFotoArtikel($single_artikel['gambar1'], 'sedang') }}" />
				</a>
			</div>
			@endif
			@if ($single_artikel['gambar2'] != '' and is_file(LOKASI_FOTO_ARTIKEL . "sedang_" .
			$single_artikel['gambar2']))
			<div class="sampul">
				<a data-fancybox="gallery" href="{{ AmbilFotoArtikel($single_artikel['gambar2'], 'sedang') }}">
					<img width="270px" style="float:left; margin:0 8px 4px 0;" class="img-fluid img-thumbnail"
						src="{{ AmbilFotoArtikel($single_artikel['gambar2'], 'sedang') }}" />
				</a>
			</div>
			@endif
			@if ($single_artikel['gambar3'] != '' and is_file(LOKASI_FOTO_ARTIKEL . "sedang_" .
			$single_artikel['gambar3']))
			<div class="sampul">
				<a data-fancybox="gallery" href="{{ AmbilFotoArtikel($single_artikel['gambar3'], 'sedang') }}">
					<img width="270px" style="float:left; margin:0 8px 4px 0;" class="img-fluid img-thumbnail"
						src="{{ AmbilFotoArtikel($single_artikel['gambar3'], 'sedang') }}" />
				</a>
			</div>
			@endif
		</div>
		...
		<div class="box-body">
			...
			<table class="table table-bordered table-striped dataTable table-hover">
				<thead class="bg-gray disabled color-palette">
					<tr>
						<th colspan="2" style="text-align: left;"><i class="fa fa-comment"></i> {{
							$data['pengguna']['nama'] }}</th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<table class="table table-bordered table-striped dataTable table-hover">
								<thead class="bg-gray disabled color-palette">
									<tr>
										<th style="text-align: left;"><i class="fa fa-comment"></i> {{
											$children['pengguna']['nama'] }}
