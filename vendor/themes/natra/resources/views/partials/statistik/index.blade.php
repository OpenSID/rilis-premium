    ...
    <div class="box-body">
        ...
        <div class="box-stats d-flex justify-content-end">
            <div class="btn-group-xs">
                <a class="btn {{ (($default_chart_type ?? 'pie')=='pie') ? 'btn-primary' : 'btn-default' }} btn-xs"
                    onclick="switchType(this);">Bar Graph</a>
                <a class="btn {{ (($default_chart_type ?? 'pie')=='column') ? 'btn-primary' : 'btn-default' }} btn-xs"
                    onclick="switchType(this);">Pie Cart</a>
