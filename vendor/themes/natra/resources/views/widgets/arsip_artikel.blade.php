...
<div class="single_bottom_rightbar">
	...
	<div class="tab-content">
		@foreach (['terkini' => 'arsip_terkini', 'populer' => 'arsip_populer', 'acak' => 'arsip_acak'] as $jenis =>
		$jenis_arsip)
		<div id="{{ $jenis }}" class="tab-pane fade in @if ($jenis == 'terkini') active @endif" role="tabpanel">
			<table id="ul-menu">
				...
				<tr>
					<td colspan="2">
						<span class="meta_date">{{ tgl_indo($arsip['tgl_upload']) }} | <i class="fa fa-eye"></i> {{
							hit($arsip['hit']) }}</span>
					</td>
				</tr>
				<tr>
					<td valign="top" align="justify">
						<a href="{{ site_url('artikel/'.buat_slug($arsip)) }}">
							...
							<img width="25%" style="float:left; margin:0 8px 4px 0;"
								...
								data-src="{{ base_url(LOKASI_FOTO_ARTIKEL.'sedang_'.$arsip['gambar']) }}" />
							@else
							<img width="25%" style="float:left; margin:0 8px 4px 0;"
								class="yall_lazy img-fluid img-thumbnail" src="{{ asset('images/img-loader.gif') }}"
